...
# ===== 설정 =====
TOKEN = os.environ.get("DISCORD_TOKEN")  # Render 환경변수에서 가져옴

# 입장 알림을 보낼 텍스트 채널 이름 (서버에 맞게 수정)
ANNOUNCE_CHANNEL = "블리-공지사항"  # 원하는 채널명으로 바꿔줘

# 온오프 상태
join_alert_enabled = True

# 등급별 입장 메시지 (역할 이름: 메시지)
ROLE_MESSAGES = {
...
async def on_message(message):
    ...
    if "안녕" in content:
        ...
        await message.channel.send("심심하면 블리 방송 보러 가요~ 📺")
